...
const SeverityBadge = ({ s }) => {
  ...
  return (
    <span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium border ${cls[s] || cls.info}`}>
      {s}
    </span>
  );
};
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] p-6 font-mono">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-500 mt-1">Track issues affecting your water supply</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#1E1E1E]">
                  {['Subject', 'Description', 'Time', 'Status', 'View'].map((h) => (
                    <th
                      key={h}
              ...
              <tbody>
                {alerts.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-4 py-12 text-center text-gray-600 font-mono text-sm">
                    ...
                    <>
                      <tr
                        ...
                        className={`border-b border-[#1E1E1E] hover:bg-[#161616] transition-colors border-l-[3px] ${
                          borderBySeverity[alert.severity] || 'border-l-transparent'
                        }`}
                      >
                        {/* Subject */}
                          ...
                          <td colSpan={5} className="px-6 py-5">
                            <div className="grid grid-cols-2 gap-6">
                              ...
                              <div className="space-y-3">
                                <div>
                                  <p className="text-xs text-gray-500 font-mono uppercase mb-0.5">Subject</p>
                                  <p className="text-white text-sm font-mono">{alert.subject}</p>
                                </div>
                                <div>
                                  <p className="text-xs text-gray-500 font-mono uppercase mb-0.5">Description</p>
                              ...
                              <div className="space-y-3">
                                <div>
                                  <p className="text-xs text-gray-500 font-mono uppercase mb-0.5">Severity</p>
                                ...
                                <div>
                                  <p className="text-xs text-gray-500 font-mono uppercase mb-0.5">Time</p>
                                ...
                                <div>
                                  <p className="text-xs text-gray-500 font-mono uppercase mb-0.5">Source</p>
                                  <p className="text-gray-300 text-sm font-mono">
